...
const CreateSVG = () => {
  return (
      <PieCircle slices={[{percentage: "0.10", color: "blue"}, {percentage: "0.20", color: "green"}, 
      {percentage: "0.25", color: "red"}, {percentage: "0.30", color: "yellow"}]}/>
  );
}
...
export const PieCircle = (props) => {
  ...
  return (
    <svg viewBox="-1 -1 2 2" style={{transform: [{rotate: '-90deg'}]}} height="100" width="100">
        {
